...
QT_MOC_LITERAL(1, 10, 8), // "sigReset"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 15), // "calculateAddNum"
QT_MOC_LITERAL(4, 36, 6), // "addNum"
QT_MOC_LITERAL(5, 43, 15), // "calculateSubNum"
QT_MOC_LITERAL(6, 59, 6), // "subNum"
QT_MOC_LITERAL(7, 66, 8) // "btnReset"

    },
    "Calculate\0sigReset\0\0calculateAddNum\0"
    "addNum\0calculateSubNum\0subNum\0btnReset"
};
...
void Calculate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { int _r = _t->calculateAddNum((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 2: { int _r = _t->calculateSubNum((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 3: _t->btnReset(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Calculate::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Calculate::sigReset)) {
                *result = 0;
                return;
            }
        }
